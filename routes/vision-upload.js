...
// album-search lives in routes/vision-link.js — it needs no local filesystem,
// so it stays available when VISION_UPLOAD_ENABLED is off (i.e. on Render).
...
// link-album also lives in routes/vision-link.js, for the same reason.
