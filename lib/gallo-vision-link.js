...
// files (GMVault Captures, Batch 02, CMS Exports, …) — masters live under
// "Rendered Files/" (folder-per-album) and "Gallo Imports Master/" (flat
// GalloImports folders, Artist_Album_CAT_Track.wav). Other buckets are indexed
// whole. Override via buildVisionIndex({ scope }).
export const DEFAULT_SCOPE = { 'gallo-digital-cupboard': ['Rendered Files/', 'Gallo Imports Master/'] }
